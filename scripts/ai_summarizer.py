...
def build_user_prompt(articles: list[dict]) -> str:
    lines = [
        ...
        "",
        "  3. ## 🇪🇺 AI Act & Regulace",
        "     Zaměř se PRIMÁRNĚ na EU AI Act — implementace, nové povinnosti, termíny, sankce,",
        "     stanoviska EU institucí, národní adaptace (včetně ČR). Dále: AI safety,",
        "     deepfakes, autorská práva, dopady na trh práce.",
        "     Zdroje označené [AI Act] zařaď do této sekce přednostně.",
        "     Pokud jsou k dispozici AI Act zprávy, tuto sekci VŽDY zahrň.",
        "     Pokud nic relevantního není, tuto sekci vynech.",
        "",
